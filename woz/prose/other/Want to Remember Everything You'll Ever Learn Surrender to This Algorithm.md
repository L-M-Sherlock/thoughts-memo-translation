...
沃兹尼亚克令人沮丧的数字与艾宾浩斯在自己的实验中记录的结果基本一致，并且在此后的几十年里被其他心理学家证实。如果学生还是设法成为他们所学的一些东西的专家，这并不是因为他们保留了课程中的材料，而是因为他们专注于一个相对狭窄的子领域，在那里强烈的练习使他们的记忆保持新鲜。当涉及到语言时，公认的智慧是，沉浸式环境——通常相当于直接移民——是实现语言流利的必要条件。一方面，这是一个有用的建议。另一方面，这也是对无数课堂时间价值的一个糟糕的评论。学习东西很容易。但记住它们——这就是某种无望感的来源。
...
实验室测试的技术和传统教育方法论之间的斗争持续了几十年，可以说心理学家输了。所有这些在实验室里对人类记忆的研究--使用无意义的音节、随机数字、图片、地图、外国词汇、分散的点--对实际操作的影响如此之小，以至于最终它们的无关性激起了反抗。在 70 年代末，创造了认知心理学这一术语的先驱研究者乌尔里克-奈瑟（Ulric Neisser）对艾宾浩斯和他的科学亲属的方法发起了广泛的攻击。
...
显然，计算机是答案，而且从 1960 年代开始，人们偶尔会提出使用计算机的想法。但除了实验软件外，没有任何东西被建造出来。心理学家们主要对理论和模型感兴趣。教师们对成功的直接迹象感兴趣。学生们在补习以通过考试。真正进步的回报在某种程度上过于抽象，过于延迟，无法以有用的方式反馈给系统。我们需要的不是一个学术性的心理学家，而是一个工匠，一个有大量时间的人，一个有数学天赋的人，一个有奇怪的文化气质的人，使他认为他应该真正记住他学到的东西。

**我第一次见到沃兹尼亚克的那天，**我们在一个多风的海滩上走了7英里。我穿着商务装，因时差而半昏迷；他穿着运动服，以一种浮力十足的步态向我走来，似乎要腾空而起。他要求我走在远离水的一侧。"他说：「人们说，当我兴奋时，我倾向于向他们的方向漂移，所以我最好站在离海更近的地方，这样我就不会把你推进去。」4
...
虽然世界语是他的世界主义梦想的理想表达，但英语是现实世界的主要实施方式。虽然他从未踏足过英语国家，但他却能流利地使用这门语言。「以前给我带来麻烦的两个词是 **perspicuous** 和 **perspicacious**，」当我们在一家小小的海滨餐厅喝着加有覆盆子糖浆的啤酒时，他坦白说，我们是那里唯一的顾客。「然后我找到了一个记忆法，输入 SuperMemo 中：clear/clever。现在我从不误用它们。」
