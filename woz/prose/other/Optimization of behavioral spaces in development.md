...
可以将限制孩子们的行为空间的比作限制他们进入图书馆。就[拼图游戏比喻](https://supermemo.guru/wiki/Jigsaw_puzzle_metaphor)而言，小的行为空间代表着拼图增长时，拼图碎片很少或拼图空间受限。在[知识树](https://supermemo.guru/wiki/Optimization_of_education#The_tree_metaphor)或[结晶](https://supermemo.guru/wiki/Knowledge_crystallization)的比喻中，情况则相当于一棵知识之树或一颗知识的结晶在一个小盒子里成长。
