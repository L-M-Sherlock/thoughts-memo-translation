...
- **运动缺乏**：（大多数）数字技术减少了运动的必要性

- **睡眠障碍**：相位障碍大为流行（特别是青少年时期的 DSPS，即延迟睡眠期综合征）

- **食物**：运动减少导致饮食结构失调，食欲控制不佳，以及肥胖。

- **学校**：“数字生活”的丰富往往会导致学校成绩的下降
...
- **近视**不需要被视作病症。相反，它是对周边世界的一种自然适应。问题的正确解法是促使人们锻炼眼睛的适应系统，比如增加在户外晴日下的运动，更多地享受大自然。

- 应对**不运动**的最好办法是运用成瘾的力量。在无需运动的现代世界中，人们更难从运动中获得奖励。这就是为什么简单如买个滑板的举动可能还不够。而若身边有榜样，如家中有人滑滑板，那么效果会更好。定期锻炼是最好的保证。我无法开出详细万能的“处方”，但我个人已利用健康的成瘾养成了定期锻炼的习惯。这个问题应该可解，因为我的周围有许多正面案例

- **睡眠**：我认为，与孩子立下约定，以限制屏幕使用时间（如晚上 18-19 点不看屏幕），应该不难。我反对在学习中使用贿赂，但支持对约定的遵守加以补偿。在晚上减少蓝光摄入和兴奋状态，就可以减轻相位延迟（见：[治愈 DSPS 和失眠](https://supermemo.guru/wiki/Curing_DSPS_and_insomnia)）
