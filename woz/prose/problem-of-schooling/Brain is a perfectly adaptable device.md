...
一个 10 岁的孩子可能因为迷恋电脑而写不出字来。他可能使用语音，也可能使用键盘。当被要求写出弯弯曲曲的线条（译注：在纸上写字）时，他可能会抱怨「为什么你让我做这些愚蠢的事情？我的生活中不需要与它们有关的**任何东西**」。一个早熟的 4 岁艾斯伯格症候群患者可能学会在键盘上输入相对复杂的文字，并通过语音合成来验证他的输入。如果他需要的是语音输入，那么一个晚熟的人可能对所有形式的写作上都有困难。
