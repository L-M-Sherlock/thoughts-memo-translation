...
在进化的路径中，这里有很多有关霸凌的社会适应现象，并在不同的社会环境下予以体现。在进化的过程中，适应现象可能包括在数量上寻求安慰，在对立或竞争中寻求团结以实现目标，寻求支配地位等等。观察黑猩猩的霸凌行为有启示，因为它剥夺了来自抽象推理和/或语言的干扰。

在社会群体、封闭空间、某些个人优势和目标人群中，霸凌是不可避免的。这只是我们基因构成的一部分，反映了决定博弈论策略的个人不同目标。
