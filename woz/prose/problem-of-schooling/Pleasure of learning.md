...
伏隔核和腹侧被盖区参与快乐、对快乐的预期和对信号的评估。来自[知识评估网络](Knowledge Value network](https://supermemo.guru/wiki/Knowledge_valuation_network)的信号，在其[动机和情感的反应](https://supermemo.guru/wiki/Brain_centers_involved_in_valuation_of_anticipated_outcomes：_nucleus_accumbens_and_VTA)中，都汇聚到这些领域。多巴胺与对快乐的预期有关。由于多巴胺与注意力有关，单是对快乐的预期就能改善学习，因为更好地关注了预期会带来快乐的信息来源。
...
我们还应该注意到，复习时快乐的大幅下降不是由于竞争性学习，而是由于[长期记忆巩固](Long Term-Memory consolidation](https://supermemo.guru/wiki/Two_component_model_of_memory)，这可能导致信号在系统中高效流动。竞争性学习在模式识别中可能很重要，但在联想学习中，高[可提取性](https://supermemo.guru/wiki/Retrievability)会削弱重复接触带来的快乐。
...
「合意困难」这一概念可能会成为容忍在校学习带来的不快的借口。在这里，我会解释为什么这个借口是不公正且危险的。

Robert Bjork 可能是学习理论方面最好的专家。如果他告诉你在学习中困难是值得的，那么他是对的，这与「好的学习总是令人愉快」这一事实并不矛盾。合意困难是一群概念的集合体，在这些概念中，学习障碍会促使更好的学习。让我们结合学习的乐趣，将之逐一击破：

- **[主动回忆](https://supermemo.guru/wiki/Active_recall)**：主动回忆的效果优于被动复习。主动回忆更难。这是一个合意困难。我们在学习中需要主动回忆，因为这是唯一可以在[间隔重复](https://supermemo.guru/wiki/Spaced_repetition)中有效地重新巩固记忆印迹的过程。每当我们在实践中运用有用的知识时，我们就是在主动回忆。这种使用是令人愉快的，因为它可以提高生产力，这是一种学习之外的奖励。人类只是喜欢[实现目标](https://supermemo.guru/wiki/Setting_goals_can_change_your_life)。如果复习是人为计划的，就像在 [SuperMemo](https://supermemo.guru/wiki/SuperMemo) 中一样，它不会产生富有成效的行为，而且很容易失去吸引力。SuperMemo 的所有成功用户都将复习与他们的目标联系起来。他们将每一个条目和每一次重复都视为通向更美好未来的一步。然而，并不是所有的用户都有这样的想象力。这就是为什么 SuperMemo 效率惊人，却并没有使人类为之倾倒的原因。

- **[间隔重复](https://supermemo.guru/wiki/Spaced_repetition)**：记忆的[可提取性](https://supermemo.guru/wiki/Retrievability)更低时，记忆[巩固](https://supermemo.guru/wiki/Consolidation)更有效。这会导致[回忆](https://supermemo.guru/wiki/Recall)更困难。这是一个合意困难。与[主动回忆](https://supermemo.guru/wiki/Active_recall)一样，[复习](https://supermemo.guru/wiki/Review)的奖励来自于知识和生产力的使用。在 [SuperMemo](https://supermemo.guru/wiki/SuperMemo) 中，默认情况下，大多数复习以成功回忆结束，难度和快乐之间可能存在某种联系。同样，只有 SuperMemo 的一小部分用户会发现这个过程是令人愉快的。那些没有这种感觉的人通常不会坚持很长时间就会退出。我们告诉所有用户，让 SuperMemo 变得有趣，否则它不会对你起作用！另见：[知道的乐趣](https://supermemo.guru/wiki/Pleasure_of_knowing)

- **渐进复习**：SuperMemo 提倡按间隔分散学习。从记忆力和创造力的角度来看，在较长的时间内分别阅读一篇文章的各个部分会更有效率。同样的道理也适用于看视频或听课。这会导致上下文回顾的问题，但这是次要的。不过，这在创造性阐述方面带来了额外的好处。它还改进了记忆编码、泛化和长期记忆巩固。矛盾的是，这些额外的困难会产生额外的学习效率，使得[渐进阅读](https://supermemo.guru/wiki/Incremental_reading)成为最令人愉快的学习形式之一。

- **学习情境**：在回忆提取时更改上下文是一种非常简单有效的合意困难。如果编码正确，提取就会成功，这样更有效，有价值。如果语境变化产生了泛化，优化了记忆编码，学习的有效性就会增加，学习的奖励也会增加。

- **解决问题**：解决问题可以是非常愉快的。问题越难，找到解决方案的快乐就越大。解决问题涉及一个学习过程，因为解决问题需要中间步骤，这会将新知识存储在记忆中。所有这些步骤都是令人愉快的。如果学生在任务中挣扎，没有进展，就学不到什么，也得不到任何奖励。这就说明，这些任务太难了。如果学生没能解决问题，但还是通过中间步骤取得了进展，即使这些步骤没有通向解决方案，他们也进行了一定的学习，得到了一定的奖励。同样，如果困难是值得追求的，它将带来奖励。如果没有奖励，就表明困难似乎是无法克服的。这种情况下，困难就既是无意义也是不值得追求的。

- **以实践促学习**：以实践促学习可能包括玩耍、创意、解决问题等。这需要更多的时间，往往会带来更好的结果和更多的奖励。

- **延迟反馈**：延迟反馈在某些情况下可能会导致更多的处理。简而言之，如果老师不告诉你你做得有多好，你可能会多好奇一段时间。这可以有利于记忆。如果是这样的话，最终的效果将是值得的。

- **收回帮助**：我在[学校压制学习内驱力](https://supermemo.guru/wiki/Schools_suppress_the_learn_drive#Teacher_problem)的上下文中写了关于收回帮助的内容。没有得到答案的孩子可能会变得更好奇。好奇心增加了学习的奖励。在纠正错误的现实模型方面没有得到帮助的学生，会因为靠自己解决不一致而获得更高的奖励。

- **其他困难**：可以改善学习的障碍是无穷无尽的，其中一些可能是因为荷尔蒙的本质，一些可能涉及激励力量。所有这些障碍的共同点似乎是某种形式的更深层次的处理、记忆巩固和注意力的改善等等。不可避免的是，促使更好学习的障碍也涉及到更好的奖励。

合意困难不会剥夺学习的乐趣。恰恰相反，它使学习更有效、更有趣。如果过于困难，到令人不快的程度，那么困难就不再是值得追求的了。这个简单的等价来自于[学习内驱力](https://supermemo.guru/wiki/Learn_drive)的奖励系统的机制。
...
我们生来就热爱学习。这种热爱通常在[强制学校教育](https://supermemo.guru/wiki/Compulsory_schooling)的那些年里很快就会消失。我们对学习的热爱持续的时间越长，对大脑、健康和人类的益处就越大。热爱学习与上瘾无关。[上瘾](https://en.wikipedia.org/wiki/Addiction)的定义包括由于强制参与某项活动而产生的不良后果。

与益处相比，学习的负面副作用微乎其微。一定程度的贪婪，甚至[冲动](https://supermemo.guru/wiki/Rage_to_master)，可以进一步促进积极的影响。提高一个人的学习热情是可能的。好的学习是进一步学习的最好的助推器。
...
我听说，如果没有最后期限或学校强加的目标，学习将被电子游戏、小说、电视、业余爱好、运动等所取代。出于许多原因，这可能是对的。这些活动中的某些可能会给人带来与学习无关的乐趣。然而，它们也有学习或锻炼方面的益处。一个全面发展的学生应该可以自由地放慢脚步，把时间分配给有趣的学习和其他有趣的活动。缓慢的进展可能会带来更多的好处。

在学习的方程式中，不可能在良好的学习之后产生不快乐。罪魁祸首永远都在别处。所有的负面因素都应加以研究和消除。

归根结底，即使存在与考试、证书、职责相关的不愉快，这种不愉快也应该由学生自愿强加给自己。

**愉快的学习可能会被淹没在压力、坏人、糟糕的学校、糟糕的教科书等造成的不愉快中**。
...
自由学习很有趣，但，学习作为抵抗抑郁的良方，靠的不是乐趣。

记忆是一个可能引发或抑制抑郁的因素。记忆决定了输入信号在大脑中的行进方式。记忆决定了哪些概念与输入或神经激活有关。记忆决定了我们对过往汽车声音的反应。它可能会唤起愉快假期的回忆，关于埃隆·马斯克的灵感，或者是一场导致所爱之人残废的车祸的记忆。

要让记忆对情绪产生重大影响，我们需要很多记忆。仅仅坐下来与心理治疗师会谈并了解一些关于大脑、生活或应对策略的关键事实是不够的。在大脑中形成健康的轨迹需要数月甚至数年的学习。我们可能建立起固有的乐观或悲观的联想。我们需要数以千计的这样的联结来改变平衡。然而，即使是多年的学习也可能很容易被病理或创伤所颠覆。神经激素可以立即改变大脑的工作模式。神经激素水平的改变会立即使一组可能对情绪产生负面影响的记忆获得优先。创伤可以植入记忆，触发新的激活源，以覆盖其他的激活源。换句话说，如果切换了正在使用的轨迹，或者大脑中产生了一个新的激活源，那么好的记忆可能会变得毫无价值。几乎不可能用学习去缓和关系密切的人的死亡带来的痛苦。

一旦抑郁症发作，受影响的人将面临双重打击。不仅是好的记忆在竭力抵御。不好的记忆开始盘旋，加强它们自己的新轨迹，并占据上风。大脑重新编程，使情绪的平衡朝着错误的方向倾斜。当这个过程变得失控时，我们就会面临临床抑郁症。更糟糕的是，抑郁症患者失去了对生活和对学习的热爱。

学习会打乱这个循环吗？这可能是非常困难的！尊重[昼夜节律周期](https://supermemo.guru/wiki/Natural_creativity_cycle)是恢复受扰的大脑的第一步。在昼夜节律周期中，需要捕捉创造力的峰值窗口来尝试治疗性学习。学习需要多产、专注、有效和愉快。[渐进阅读](https://supermemo.guru/wiki/Incremental_reading)如果不是那么困难的话就太棒了。对于一个在该领域没有技能的抑郁症患者来说，[SuperMemo](https://supermemo.guru/wiki/SuperMemo) 不是一剂良药。已经太迟了。试图在糟糕的心理状态下掌握渐进阅读只会让事情变得更糟。这可能会导致对渐进阅读的厌恶。

如果可以学习，它可以起到避难所的作用，这可能有助于抑制负面记忆，建立新的联系。从那时起，构建新知识卷须的过程就开始了。这个应该可以让我们的头脑对世界做出更乐观解释的过程是缓慢而艰苦的。在大多数严重的情况下，可能需要几个月或几年的艰苦工作，且结果无法保证。

最终的结论是，学习不是万能的，但它可以在治疗中发挥重要作用。最重要的是，通过丰富而有效的学习，可以提前几年避免患抑郁症的风险。学习必须在自由和尊重[学习内驱力](https://supermemo.guru/wiki/Learn_drive)的条件下进行。简而言之，**热爱学习是通向热爱生活的好方法。**
