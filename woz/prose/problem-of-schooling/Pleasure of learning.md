...
教育的主要问题和这种想法有关：学习将带来不悦，为了达成更多学习目标，学习者应[忍受](https://supermemo.guru/wiki/The_grind_is_the_glory)这种不悦。

数不清的教育工作者都认为，学校应该像工作一样：不愉快，但不得不做。然而在本章中，我要说明的是：

**好的学习本质上是令人快乐的**，没有快乐就没有好的学习。

「学习使人不悦」这一谬误如此盛行，以至于优秀教师也认同痛苦是学习的一部分。

在这一章中，我将指出学习的快乐是深深刻在我们脑海里的，以及我们是如何以牺牲人类的健康、学习、创造力和最终未来为代价，系统地摧毁这种[源自进化的天赋](https://supermemo.guru/wiki/Education_counteracts_evolution)的。

教育的主要问题也是社会的主要问题。我们正通过破坏学习的乐趣，大力摧毁着生活的乐趣。一个让无数人过上不幸生活的教育系统被建立了起来。

你很可能对我的话持怀疑态度，因为「学习使人不悦」这一谬误正是[学校教育](https://supermemo.guru/wiki/Schooling)的一个强效的副作用。因此，本章旨在说服您。而要破除这一谬误，就有必要了解**新知识在大脑中编码的简单机制**。
...
在估值网络中，情绪估值会把信息与负责饥饿、口渴、性欲等的原始大脑中枢的奖励联系起来。理性估值则以知识为基础。如何回答**「最近的快餐店在哪里？ 」**，就是一例纯粹情绪估值。基于知识的估值可能更加复杂，高度网络化，即依赖于次级估值网络。要回答「哪本书最适合我的考试？」，就得基于个人目标来评估，这些目标包括通过考试、获得学位、就业前景，以及人生目标。情绪估值和理性估值在生理上相互隔离。情绪估值来自被比喻为三重脑的较原始部分：爬行动物和古哺乳动物的结构。例如，特定刺激被丘脑处理后，可能会向杏仁体发送单独的信号以进行情绪估值，并向新皮质发送信号以进行理性估值。情绪脑在遗传学上更古老。个性和教育决定了理性估值能否控制或推翻情绪估值。

### 快速思考中的决策树

**知识估值网络**是确定单条知识价值的记忆连接网络。如果将学习视为一种任务，那么估值网络将确定**感知的任务价值**（参见：[问题估值网络](https://supermemo.guru/wiki/Problem_valuation_network)）。

用计算术语来说，**知识估值网络**可以比作[决策树](https://en.wikipedia.org/wiki/Decision_tree)。目标和情感确定了根节点的核心价值。知识之间的语义连接可以看作从目标到细节的价值传递。由稳固、精选的知识所良好组织的[语义网络](https://supermemo.guru/wiki/Semantic_network)只需要几毫秒就能做出专家决策。这就是卡尼曼（译注：《思考：快与慢》作者）所说的自动[快速思考](https://supermemo.guru/wiki/Fast_thinking)（对需要**放慢速度**解决的难题感兴趣，请参阅《[如何解决任何问题？](https://supermemo.guru/wiki/How_to_solve_any_problem%3F)》）。构成决策或解决问题的基础的同一过程，也参与了知识估值。像许多专家决策一样，估值十分迅速，并且几乎不需要意识参与。简而言之，我们有时死都想知道一些事情，却完全无法解释为什么。这个过程几乎不受我们自己的控制，更不用说学校老师的控制了。为了高效学习，估值必须很高。
...
> 图：Xefer.com 是帮助将知识当作网络理解的工具。它依赖于维基百科页面之间的语义链接。

### 教育中的估值网络

大脑在多年的学习过程中建立了估值网络。通过[睡眠中的优化](https://supermemo.guru/wiki/Memory_optimization_in_sleep)和[遗忘](https://supermemo.guru/wiki/Forgetting_curve)，估值网络经过打磨、抛光，为高效运行做好万全准备。这使估值捷径易于穿梭。正在挑选课后练习的学生，不会把这场考试当作人生大事。他更可能这样，建立捷径：「接下来的三个月，我只想通过地理考试」。

知识估值网络往往高度个人化，因人而异。例如，对于理性和情感的倾向不同，权衡不同目标标准的也可能不同。罪犯会形成异于常人的估值网络，而一个立志为人类谋福祉的研究员，自然也有别致的估值网络。

估值网络的发展和个人秉性、人生履历、成长环境息息相关。儿童时期的创伤或人格特征，如冲动，更有可能培植出犯罪心态。受早年生活一些创伤事件影响，更可能发展出畸形、一根筋的估值网络（参见：[错误向量](https://supermemo.guru/wiki/Falsity_vector)）。环境和可用的知识将决定激情、兴趣、目标和估值子网络(请参阅：[概念化](https://supermemo.guru/wiki/Conceptualization)）。
...
[知识估值](https://supermemo.guru/wiki/Knowledge_valuation)的网络性质可能代表其使用了大脑皮质的资源。事实上，大多数研究人员似乎倾向于认为：整个估值系统可能[以眶额皮质（OFC）为中心](https://supermemo.guru/wiki/Orbitofrontal_cortex_as_the_supreme_reward_processor)，越靠近其前部区域则抽象程度越高。关于单个子系统如何影响估值的模型和假设有很多（如共同通证、共同尺度、躯体标记、按内容评价、多成分评价、认知-动机界面、平行评价、定位主义与建构主义模型等）。在**共同通证模型**中，来自所有子系统（享乐底物）的所有估值都被整合在一起，并提供了「想要」或「喜欢」的最终信号。例如，（1）来自内侧 OFC（mOFC）的基于知识的估值可能与（2）来自伏隔核（NA）的奖励预期相结合，以及（3）来自脑岛的食物评估信息可能会影响你选择下一顿饭去哪吃。
...
无休止的虚假奖励和轻微处分可能会使知识估值过程停滞，并损害在学校的长期学习。

#### 目标 vs. 习惯

知识估值网络是[自由学习](https://supermemo.guru/wiki/Free_learning)的核心。相比之下，[被动学校教育](https://supermemo.guru/wiki/Passive_schooling)则导致[习得性无助](https://supermemo.guru/wiki/Learned_helplessness)。人们可能一开始自然而然主动追求某些目标，一旦受过强迫教育，就变得习惯被动（反过来，在追求目标中摸爬滚打，则会收获健康的习惯）。系统中较低的估值（没怎么激活兴趣概念图）会抑制知识估值网络的输出。如此，学习自然没劲。一旦[学习内驱力]（https://supermemo.guru/wiki/Learn_drive）枯萎，好奇心消失，生活就变成一系列习惯，毫无激励（参见：[学校带来的 50 个坏习惯](https://supermemo.guru/wiki/50_bad_habits_learned_at_school)）。
...
估值网络的力量往往和教育系统对峙，我自己就是一例，还特显著：

1985 年，我算出了帮助长期记忆的近似函数，使知识复习保持最佳间隔。此即[间隔重复](https://supermemo.guru/wiki/The_birthday_of_spaced_repetition:_July_31,_1985)的诞生。最初，该函数应用在[纸笔版 SuperMemo](https://supermemo.guru/wiki/SuperMemo_on_paper)。几个月内，我意识到这个系统非常强大。只要一台电脑，我就能让它功效翻倍。然而，我不知道有谁可以根据我的数学编写学习软件。那个年代，波兰的整个程序员群体，要么是在大型机上运行 Fortran 或 Cobol 的老古董，要么就是业余爱好者，使用微型计算机（如 ZX81、Commodore 64 或 ZX Spectrum），鱼龙混杂。于是，我决定亲力亲为。不过，我还没掌握编程技巧。作为一名计算机科学的学生，我得向老师寻求帮助。然而，我们唯一的编程课程是数据点的汇编语言。这些技能对于处理寄存器和得出 11*11=121 非常有用。我则想学习一些对 [SuperMemo](https://supermemo.guru/wiki/SuperMemo) 编程更有用的东西。我的学校一直要求我学习计算电子电路的电阻，或者学习符号积分。我的知识评估固执网络产生了一个简单的输出：**编程技能**将导致产生 **[SuperMemo](https://supermemo.guru/wiki/SuperMemo)**，这将导致**更快的学习**（在所有领域，包括。电子学或微积分）。我下定决心要学习编程。我的学校决心阻止我（通过加载负担其他必修课）。无奈之下，我进入了波兹南的经济大学，那里有一门算法语言课程。该课程的重点是 [Pascal](https://en.wikipedia.org/wiki/Pascal_(programming_language))。我不得不做我平时的课业，在额外的时间里学 Pascal 课。那门课很不错，但我们所有的学习都是理论上的，也是纸面上的。在那段时间（1986 年），波兰大学的个人电脑很少，大多数实际应用程序都运行在名为 [Odra](https://en.wikipedia.org/wiki/Odra_(computer)) 的大型机上（1960 年在波兰为苏联挡路生产）。当我终于有了我的第一台计算机时：[ZX Spectrum](https://en.wikipedia.org/wiki/ZX_Spectrum)（1986 年 1 月 4 日），我终于可以开始学习真正的计算机编程了。在我的电脑到来之前，我开始写我的第一个程序。我把它写在纸上了！这是一个组织我的一天的计划有点（类似 SuperMemo 中的 **[Plan](https://supermemo.guru/wiki/Plan)**）。不久之后，我也学会了 Pascal。首先，我必须消除学校干扰，减轻课堂负担。我和我的电子电路老师达成了一项协议。我会为他做一些高分的过滤计算，这将是一个提高我的 Pascal 技能的机会。这个节目花了好几个小时才写完，简直是浪费时间。这是一个学习不良的完美例子。我几乎不明白我自己的程序是如何运作的。然而，这仍然比仅仅学习图表要好。就我的编程技能而言，那次学习很好，我进步了很多。

不懂编程的人可能无法知会，大学课程和自己编程的知识估值差别判若云泥。当我的同事忍受着乏味的电子学和计量学讲座时，我则开始做自己的事。学校课堂什么也学不到。除了，有时在 Pascal 课外课程中学到一些。然而，只有以激情和明确目标为后盾的实践性知识才是重要的。到1987年12月，我努力创作[SuperMemo](https://supermemo.guru/wiki/SuperMemo_1.0_for_DOS) 的第一个版本，那种状态简直巅峰，它彻底改变了我的人生进程。我的导师 Zbigniew Kierzowski 博士心胸开阔，让我把[我整个硕士的Thesis](https://supermemo.guru/wiki/Optimization_of_learning)]都研究“SuperMemo”。基尔兹科夫斯基教授，80岁生日快乐！对于一个学生来说，有这么大的自主决定权，然后再加上论文是用英语写的，这是相当不寻常的(不到十年后，波兰议会试图将这种行为定为非法)。这涉及某一年的大规模政府内斗和军事风波。

我如今最主要的快乐源泉是 [SuperMemo](https://supermemo.guru/wiki/SuperMemo), 但我的学校几乎毁灭了它，但不是因为有人怀抱恶意。我的大多数大学老师都很了不起。罪魁祸首是迫使学生学习死板的[课标](https://supermemo.guru/wiki/Curriculum)系统。给予学生创造性表达空间，才是教育最好的基础。

**我的学校乐此不疲地阻扰我完成一件大事，这事简直是重中之重，谁也没想到，日后，它支撑了我职业生涯和未来的一切**。要是我更顺从一点，更迂腐一些，更在意周遭社会压力，我就会成为「更好 」的学生，在电子电路理论、微积分、计量学和抽象代数上投入更多时间。但是，果真如此，这篇文章就永远不会问世。[此链接](https://supermemo.guru/wiki/SuperMemo_Guru) 也不会存在。

我现在的生活，任何研究或工厂职位都换不来。基于强知识估值网络，任何对我的否定，都无法打倒我。

**我们要设计的教育体系，是让每个孩子都能自由发展的教育体系**

## 学习熵

有很多因素影响大脑接受不同信息与信息渠道并进行估值。在之前的章节中我们注意到影响大脑反应的不只有信息熵。还有很多因素会调节信息熵的效力。这些因素包括：编码、传送速度、预处理（比如泛化、补全、辨认等等）前置知识（估值、情感价值、信道可靠性）、最佳水平（受处理速度影响）等等。

这一过程十分复杂，需要用更恰当的概念来涵盖这些微妙之处。我建议使用「学习熵」这一术语来描述，特定场景下，教育渠道或者信息对个人的吸引力。

**学习熵指由[学习内驱力](https://supermemo.guru/wiki/Learn_drive)System]决定的某一教育性信号的吸引力。**

有的课程很无聊，有的让人目不转睛。学习熵描述不同人眼里不同课程的吸引力。

虽然熵有精确的数学定义，但学习熵的衡量，应该利用学习材料之后，奖赏系统作出的回应。就像熵依赖于信息的概率一样，学习熵依赖于信息的奖赏能力（图片、声音、语句等等）。奖赏能力与概率有关，但是具体估值主要依赖于[知识估值网络](https://supermemo.guru/wiki/Knowledge_valuation_network)。

知识估值较高，则学习熵也较高，有利于聚精会神学习，将知识内化，从而实现长期记忆。学习熵提升学习内驱力，进而提升估值，进而提升学习熵。这循环非常强大，但是遗忘、习得性无助、衰老、受伤、过量的精神资源均会控制其强度。只要理性学习、理性生活，特别是要尊重自然创造力周期，这样学习熵-学习内驱力的循环，能在学习驱动力较高的状态下保持平衡数十年。

## 信号时机 vs. 学习熵

基于学习流中个体化信息的奖励级别将决定信号学习熵的高低。一个主题枯燥的讲座的学习熵很低。上网寻找解决特定问题所需的零星信息这种行为有很高的学习熵。

## 学习熵与学习内驱力

## 最佳信息呈现

在学校中，我们可能期望课堂的学习熵都是最优水平，让学生能不停地赞叹喝彩，马不停蹄地记笔记。但更常见的情况是课堂很无聊，信息熵很高，但学习熵很低，甚至是负数。

既然最优学习熵与学生有关，老师怎么能向教室里的所有学生最优地传授知识呢？这样全面地传授知识，有时候毫无可能，有时候需要天才教师才能实现。大部分老师讲的课里，学生都无聊得昏昏欲睡，或者丝毫不懂抓耳挠腮。

课堂中只有少数的幸运儿能学到大部分知识。对很少一部分有天分的孩子来说，老师讲课可能完全讲不出新东西，非常无聊。而对于其他孩子来说，这些讲授的知识可能过于复杂，他们无法理解。此时他们如果尝试理解就会遭受巨大的挫折。一堂关于弦论的课程，可能就跟随机打乱的一段中文一样难以理解。课堂是浪费时间的绝佳方式。诺贝尔奖获得者 [Carl Wieman](https://supermemo.guru/wiki/Carl_Wieman) 将课堂比作[放血](https://supermemo.guru/wiki/Wieman:_Lectures_make_no_sense)。
...
学习这种快乐，可持续，且不会让人上瘾，除了要花时间，几乎没有副作用。此外，好的学习往往使大脑全神贯注，并通过提高[学习内驱力](https://supermemo.guru/wiki/Learn_drive)]来激发更多的学习。这意味着，用学习治疗抑郁，并非无稽之谈。

### 在学校学习

如果学习是快乐和奖励的源泉，为什么我们会在学龄儿童中看到[猖獗的抑郁](https://supermemo.guru/wiki/Incremental_increase_in_depression)？尽管学校是学习机构，但[更有可能导致抑郁，而不是充当救赎](https://supermemo.guru/wiki/I_became_so_depressed_that_I_stopped_going_to_school)。没有学习的自由，就很难有好的学习。为了让学习变得愉快，它需要由[学习内驱力](https://supermemo.guru/wiki/Learn_drive)提供动力。它不能是强制性的或胁迫性的。它必须是自由的。

### 记忆对情绪的影响

自由学习很有趣，但，学习能抵抗抑郁，靠的不是乐趣。

如果学习是可能的，它可以起到避难所的作用，这可能有助于抑制负面记忆，建立新的联系。从那时起，构建新知识卷须的过程就可以开始了。这个应该让我们的头脑对世界做出更乐观解释的过程是缓慢而艰苦的。在大多数严重的情况下，可能需要几个月或几年的艰苦工作，结果不能保证。
...
如果你正在读这篇文章，但你不确定学习能不能帮到你，那就问问自己这个问题：*你今天心情好吗？*如上所述，当你处于下行状态并寻找解决方案时，你的解读会变得更加阴暗，你可能会觉得这篇文章不够令人安慰。记住激活能的概念：你需要迈出一小步才能开始，然后你可能会被一大堆有趣的东西所吸引。
...
我们能提前决定孩子的未来吗？如果让父母在全球范围内最佳地选择未来，我们将拥有过剩的律师和医生。我们还会大幅增加沮丧的大学辍学率。如果政府能提供一点帮助，并在孩子很小的时候最好地重新分配工作，我们最终会得到一种变种的[1984](https://en.wikipedia.org/wiki/Nineteen_Eighty-Four).很少有孩子愿意在6岁时发现自己已经准备好了当簿记员或木匠的生活。选择工作显然应该基于爱和激情，而不是政府的命令。

## 学习的基本法则

这使得制定**陈述性学习的基本法则**成为可能：
...
-可预测性和新奇性都可能增加信息渠道的吸引力

- 信息渠道的吸引力取决于传递速度和处理速度

- 陈述性学习的基本法则是：**没有快乐，就没有学习！**