...
好的学习是有奖励的。但也有糟糕的学习。存在[理解失败惩罚](https://supermemo.guru/wiki/Decoding_failure_penalty).如果学生努力理解一条信息但失败了，他将受到惩罚。挫折感就是这样产生的，这是讨厌学习的开始。如果学习熵低，奖励就少，惩罚就高，净结果可能是负的。如果我们考虑到消极的奖励信号，学习熵实际上可能会呈现负值。一堂枯燥的讲座可能会带来负的学习熵，也就是抑制[学习内驱力](https://supermemo.guru/wiki/Learn_drive).
...
一旦前置知识填补了理解上的一个重要空白，一堂枯燥的讲座的学习熵就会瞬间提升。学习熵的增加将与决定知识价值的记忆轨迹的[稳定性](https://supermemo.guru/wiki/Stability)的表达式成正比（包括[知识估值网络](https://supermemo.guru/wiki/Knowledge_valuation_network)中的下降曲线）。前置知识的影响迟早会减弱，累积效应的发现将决定学习熵水平（任何给定时间，例如在讲座期间的）。
