...
- **知识是一棵树**：知识可以被想象成一棵树。所有单个知识的叶子都需要建立在[前置知识](https://supermemo.guru/wiki/Prior_knowledge)的基础上：[知识树](https://supermemo.guru/wiki/Knowledge_tree)的小枝和树枝。不了解能源、化学、核物理、天文学等，就很难了解太阳。

- **知识的来源是光**：知识之树积极寻求新知识的光芒。每一束光都为知识的进一步增长提供能量。每一片叶子都参与寻求新的光的来源。这在森林中尤其重要

- **社会是一个森林**：在一个森林里，每棵树都会优化使用它周围的空间。它将使用树冠中所有可用的空间。知识树会省略被占据的黑暗空间，而看到树冠上那些仍然亮着的斑块。社会中的每个人都会优化适应，找到自己的知识与其他人的需求的契合点。

一棵树的生长是由简单的规则决定的。叶子朝着光源方向生长，就像[学习内驱力](https://supermemo.guru/wiki/Learn_drive)寻找高[学习熵](https://supermemo.guru/wiki/Learntropy)的知识来源一样。我们发现有用的东西很有趣。如果我们遵循自然的兴趣，我们会生长出丰富的知识之树

（一个人的）知识体就像一颗一直寻找新知识扩充它的树冠的大数
...
对于一个自由的个体来说，知识树是广泛的，丰富的，跳动着快乐的知识。每一片叶子都是以最佳的方式添加的，而且非常愉快。健康的知识之树散发着快乐的温暖，影响着个人的整个生活。这是大多数人被多年严格的学校教育所剥夺的。学校教育的树结构不仅是人为的、不健康的，而且常常放射出一种非常不同的联想。学校教育的知识是一个非常薄弱的快乐来源。这就是为什么被学校教育的人很难理解[学习的乐趣]（https://supermemo.guru/wiki/Pleasure_of_learning）。他们把学习看作是工作。[强制学校教育](https://supermemo.guru/wiki/Compulsory_schooling)体系下就充满了“童工”。这就是虐待儿童。[强制学校教育必须结束](https://supermemo.guru/wiki/Compulsory_schooling_must_end)。

不开心的离校生一般都会自责其**在学校系统中的失败**

## 童年的激情

一个没有受过教育的孩子会很快转向使用电子设备。游戏几乎是不可避免的。Roblox是儿童中最受欢迎的游戏之一。家长们很少了解Roblox的情况。许多教师从未听说过这个名字。他们绝不会建议将Roblox作为职业选择。如果一个孩子在学校进展缓慢，他的PlayStation或平板电脑可能会被没收。一个在家上学的人可能被送回学校，只因为她 "缺乏[自律](https://supermemo.guru/wiki/Self-discipline)"。所有的抗议都被归咎于孩子的"[坏脾气](https://supermemo.guru/wiki/Myth:_Teenagers_hate_everything)"（但学校的奴役行为却可以免责）。

学校限制了对 [childhood passions](https://supermemo.guru/wiki/Childhood_passions)的追求，而这恰恰切断了未来天才的路

同时，不上学的孩子可能会迅速提高编程技能，并发现Roblox提供了每年在游戏中获得一百万美元的购买力的机会。这种认识可能会促使孩子从事编程的职业。通往这一职业的道路是充满激情的，也是早期的。[学校挡在路上](https://supermemo.guru/wiki/Childhood_passions)。学校建议用书法和正字法代替。当一个不上学的人在Roblox中为他的距离和角度编程时，一个上学的孩子却被背诵乘法表所折磨。[Seymour Papert](https://supermemo.guru/wiki/Seymour_Papert)在YouTube出现之前，就已经对这种不和谐的现象进行了抱怨。今天，他一定在他的坟墓里打转。请看。[学校信条的隧道视野](https://supermemo.guru/wiki/Tunnel_vision_of_school_letteracy)。
...
[自由学习](https://supermemo.guru/wiki/Free_learning)是不可预知的。它蜿蜒曲折。它开始时没有具体的目标，然后不断改变目标。因此，我们无法用测试来衡量一个非学校教育者的知识。测试需要以个人的激情和兴趣为目标。它可能是十几个科目按不同比例的混合。最有可能的是，对测试问题的回答是不令人满意的，因为在[自由学习]（https://supermemo.guru/wiki/Free_learning）中，没有强加的思维模式。重新定义自己对现实的看法是一种规范。在[自由学习](https://supermemo.guru/wiki/Free_learning)中，我们可能会遇到看似荒谬的结果，例如，一个从未将自己的时间分成7天的学生从未学会星期几。这种类型的选择性无知培养了创造力，有助于通过发散性思维解决问题，也是人类[多样性](https://supermemo.guru/wiki/Diversity)力量的一部分。
...
我在共产主义灌输时代的公共机构中接受了26年的 "教育"。我对学校的情况了如指掌，而这种了解并没有被负面情绪所玷污。我从来没有[恨过学校](https://supermemo.guru/wiki/Why_kids_hate_school)，毕业后我为这个机构辩护了很多年。
...
最终的真知灼见是令人震惊的。为促进学习而设立的机构实际上是未来更好的学习道路上的最大绊脚石。
