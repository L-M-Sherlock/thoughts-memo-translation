...
毫无疑问，Gray的观点是正确的，所有的强制都应该被根除。在这个方向上，放弃教初等年级的数学是很简单的一步。形式上的数学很容易被“玩弄数学概念”所取代。我相信拉里对教育的观点被他自己的[在家上学](https://supermemo.guru/wiki/Homeschooling)的成功所扭曲。他相信教学的魔力。他相信年轻人的头脑可以解决成年人的问题。我会敦促他反思自己在智力上的成功，以及这种成功有多少来自学校，有多少来自他自己永无止境的激情。这种类型的自省对我自己的情况很有帮助。我在学校里待了22年，过了近30年才意识到学校带来的弊大于利。换句话说，*学校教育价值*的文化烙印让我在成年后的大部分时间里都被蒙住了双眼，尽管我曾深入研究过高效学习的问题!
...
整个误解可能产生于Larry在阅读Gray时没有完整的背景。这有点像一个观察者抱怨热情的埃及古物学家在沙漠中发现的一个3厘米长的粘土贝壳中看到了一个有意义的世界。对于观察者来说，外壳没有什么意义。对于埃及古物学家来说，这可能会改变他对人类历史进程的看法。

当拉里抱怨格雷的假设时，格雷陈述了经过充分证明的科学事实。就像一篇博客文章一样，格雷并没有提及所有的参考文献。对于任何熟悉格雷巨著的人来说，没有必要在他的每一篇文章中提到[非学校教育]的话题(https://supermemo.guru/wiki/Unschooling)及其所有分支。拉里可能忽略了这个背景。由于拉里非常热衷于早读，他一定早就发现了自己和格雷的共同点:

教育中所有形式的[胁迫](https://supermemo.guru/wiki/Coercion)都应该被消除

有了这个基本共识，我们就应该让孩子们自由地学习。我们应该以辅助代替教学。翻转课堂。利用游戏和创造力。目前的系统损害了孩子们的数学推理能力，并将其当成机器人培养。证据是压倒性的，Benezet的例子只是比较有刺激性，说明教育中的激进思想会让一个毫无准备的人觉得不可思议。

## 谁才是真正的激进分子?

现在让我们来看看拉里的严厉指责:

> 激进的提议需要铁证如山的证据。[…] 英语泛读材料令人惊讶的是，一位杰出的学者会在如此微不足道的基础上提出如此引人注目的建议

我想说，如果我们有一个小样本来证明[非学校教育](https://supermemo.guru/wiki/Unschooling)优于学校教育，拉里的样本反过来也同样小。更糟糕的是，小样本表明了非学校教育的优越性。对我来说，上学比不上学更激进。在裴斯塔洛齐(Pestalozzi)时代之前，在12岁之前教数学是激进的。世界上所有最好的数学都来自于自由思想家的思想，他们花了多年时间思考科学的关键问题。没有一个现代的牛顿来自补习班。课程和考试远比自由思想更为激进。它们是现代激进的发明。从这个意义上说，拉里提出的更为激进的建议的基础更加薄弱。支持这一观点的唯一证据来自一种文化谬误:上学是好的。

几千年来，人类通过数羊来学习数学。今天，我们通过完善数学探索领域的[自学]艺术(https://supermemo.guru/wiki/Self-learning)将火箭送上月球。学校里的微积分只是对较弱学生的鞭策。未来的火箭工程师将自己热情地进行自己的计算，很少关注课程中的算法规定。向每个孩子灌输数学的激进实验已经大规模失败。失败的证据铺天盖地，无处不在。经过两个世纪的努力，足以证明情况很少改善。

## 学校扼杀了对数学的热爱

Sanger 补充说：

> 格雷似乎认为，没有受过数学训练的六年级学生在数学学年结束时对数学充满热情

格雷并不认为未经训练的孩子会有热情。他只是陈述了一个充分证明的事实，即[学校压制了学习内驱力](https://supermemo.guru/wiki/Schools_suppress_the_learn_drive)。未经训练的孩子更有可能自发地解决数学问题。他们将运用自己的推理能力，而不是经过精心训练的算法。

> 我的猜测——作者没有提供理由认为这不是事实——是，从长远来看，那些开始学习的较早的学生，尤其是像Doman的孩子，他们在幼儿的时候就开始思考和记忆关于数字的事实，他们在数学方面会更快

拉里的猜测是错误的。平均而言，学习时间早的学生在数学方面要弱得多。他们只会把[对数学的热爱](https://supermemo.guru/wiki/Pleasure_of_learning)从脑海中敲出来。指令越严格，产生的仇恨就越多。总是会有一个灵活的例外来延续学术教学有效的幻觉。其余的人将远远落后于那些天生热情的数学修补匠。

参见:[早期学术训练阻碍智力发展](https://supermemo.guru/wiki/Early_Academic_Training_Retards_Intellectual_Development)

## 非学校教育的力量

> 人们很容易同意，在美国大多数公立学校的大多数教室里，孩子们不会接受高质量的数学教育——这要归功于教育教授和教育心理学家的所有不成熟的失败，他们往往对已经被证明可以最大化学生知识的东西不感兴趣

说完这些话，我知道接下来会发生什么:学校很糟糕，但我们可以把它们设计得更好。这源于对教育最具破坏性的错觉。我们需要不断重申这样一个事实，即学校本质上是不可改革的，因为它们违反了[学习的基本规律](https://supermemo.guru/wiki/Fundamental_law_of_learning)。如果他们试图遵守法律，他们将向[非学校教育]的方向漂移(https://supermemo.guru/wiki/Unschooling)!QED。实际上，格雷的晚年一直在研究非学校教育的优越性。他真正知道如何最大化[优质知识](https://supermemo.guru/wiki/Coherence)。

拉里把他的孩子们从学校带走了，因此他的孩子们应该继续感激生活。尽管如此，拉里还是想寻找通过考试成绩验证的最有效的课程。在这一点上，他[和比尔•盖茨一样错了](https://supermemo.guru/wiki/Bill_Gates_is_wrong_about_education)。这正是我所说的基于我们从学校学到的洗脑的假设。课程是不好的，因为它不可避免地导致[强制](https://supermemo.guru/wiki/Coercion_in_learning)。测试是不好的，因为它不可避免地导致[填鸭式学习](https://supermemo.guru/wiki/Cramming)。教育应该是关于创造力和[自我发展](https://supermemo.guru/wiki/Self-directed_learning)。否则我们将变成一个顺从的机器人社会。

## 一个数学笑话的戏剧性

调查中的一件事使我下定决心要教数学。世界上所有的证据都不如个人的本能体验有说服力。操场上的小戏剧:

轶事。[为什么使用轶事？](https://supermemo.guru/wiki/Why_use_anecdotes%3F)

一个古老的数学笑话是这样说的:*船载着20只绵羊和16只山羊。船长多大岁数了?*当我发现很大一部分孩子的答案是36时，我难以置信。我挣扎着对一个严重脱轨的大脑产生同情。当我开玩笑地在一个一年级学生身上测试这个问题时，对话并不太令人惊讶。答案是50。理由是:“我妈妈25岁了。我认为队长应该聪明一点。我觉得50就可以了。”我被孩子的自信逗乐了，但注意到他妈妈开始不舒服了。好像她害怕自己会是下一个。这需要进一步的测试。我无情地问了一道数学题。当妈妈宣布那个臭名昭著的判决时，我震惊了:36岁。我立刻意识到，这只能用[毒性记忆](https://supermemo.guru/wiki/Toxic_memories)来解释。这位女士因为害怕数学而瘫痪了，她下意识地认为答案一定是数字。就像一个[成功被学校驯化的机器人](https://supermemo.guru/wiki/Asemantic_learning)一样，她给出了答案。这就是糟糕的数学训练对年轻人的影响:无用的恐惧!毫无目的的恐惧，代价是自由和长时间在学校学习。有趣的是，这位女士是一名购物店员，她似乎对数字很精通。是对数学老师提出的一个典型问题的毒性记忆，让她的头脑混乱，破坏了这一天的快乐。相比之下，一个没有受伤的孩子无畏地做了假设。我只希望他的自由思想不会在学校受到损害

这就是我如何看待一个恐慌的数学大脑中发生的事件。这一切都从认识一个典型的数学任务开始。这会立即引发“毒性记忆”(https://supermemo.guru/wiki/Toxic_memory)，将数学与焦虑状态联系起来。对数学的恐惧麻痹了所有可能通向理性解决方案的智力。用神经学的术语来说，经过良好优化的网络会触发快速、高性能、高[稳定性](https://supermemo.guru/wiki/Stability)的电路，这些电路会立即接管寻找解决方案的工作。这些电路的特点是低[连贯性](https://supermemo.guru/wiki/Coherence)，不能很好地与世界知识集成。他们的目标是通过快速思考提供机器人解决方案。多年来，通过[干扰](https://supermemo.guru/wiki/Interference)，寻找解决方案的算法可能已经失去了对任务中涉及的实际逻辑输入的响应的所有痕迹。相反，大脑将问题剥离到最基本的部分，并遵循算法:

- 如果一个数学任务中出现了两个数字，使用4个基本运算符:+，-，*，:，并选择最合理的结果

- 如果剩下的时间不多(解决测试)，选择加法，这是最简单的。在多项选择题测试中，它仍然提供25%的成功几率

- 如果数字太大，无法使用算符，那么就放弃，跳到下一个测试来解决。在现实生活中，玩一个转移注意力的游戏，掩盖你的行踪。一定不要因为你的无知而被抓住。别让别人看到你不擅长数学
...
早期的数学学术教育只是自然发展过程中一个重大中断的开始。然而，早期干预可能是造成最大损害的措施之一。

## Gray和Sanger的纪念碑

将来会有Larry Sanger和Peter Gray的纪念碑。Sanger希望看到一个新的智慧星球。他的方法有点太传统了，但不可能大获成功。另一方面，Gray并不反智。学校!Gray是这个星球上极少数真正了解[学习驱动](https://supermemo.guru/wiki/Learn_drive)机制及其对人类未来的价值的人之一。

通往更好教育的道路将是漫长而曲折的。我们最大的敌人是现行的教育体系，它在我们的头脑中留下了[大量的谬误](https://supermemo.guru/wiki/Mythology_that_keeps_the_archaic_school_system_alive)。如果没有来自[神经科学](https://supermemo.guru/wiki/Pleasure_of_learning)的有力支持，即使是最聪明的头脑也会犯蠢。详见:[学校教育问题](https://supermemo.guru/wiki/Problem_of_schooling)