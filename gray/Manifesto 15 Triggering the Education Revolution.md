...
\ 1. 「未来已经来到，只是尚未普及」（William Gibson，格莱斯顿，1999 年）。教育领域远远落后于大多数其他行业，很大程度上是因为我们倾向于向后看，而不是向前看。例如，我们教文学史，但不教导学生书写未来。我们教授历史上重要的数学概念，却不参与创造建设未来所需的新数学。此外，在学习中发生的一切「革命」都已经在不同的规模、不同的地方、不同的地方发生了。当我们鼓起勇气从彼此的经验中学习，并在实践中承担以未来为导向的风险和责任时，对我们自己和我们的组织的全面影响将会实现。
