...
会话技巧（ conversational competence）属于输入数量类，包括开始会话的方式(问候)和保持会话的方式(例如，礼貌常识)。Scarcella 的受试者 Miguel 是一位 21 岁的以英语作为第二语言的人，尽管他只有一般的“语言学”技能，但他相当熟练地掌握了这些会话技巧的工具，正如以下简短的摘录所显示的那样：
...
Miguel 通过使用几个精心挑选的例句，能够发起和保持对话。然而，像 Miguel 这样的第二语言者并不能作为标准，因为研究表明，对于会话技巧，第二语言习得者往往存在令人惊讶的严重差距(见下文)。
...
了解会话技巧的组成部分是一回事，培养学生的会话技巧则是另一回事。这里需要问的问题是会话技巧是学得的还是习得的。

我认为，对于“所有会话技巧都是可被学得的（learnable ）”这一假设，这里有很多很好的反对论据(另见即将出版的Scarcella中的讨论)。首先，它太复杂了。正如 Scarcella 指出的那样：
...
其次，即使学生设法学习了一些会话技巧的规则，它们也不会总是在需要的时候出现：在没有监控（Monitor-free）的情况下。

最有可能的是，会话技巧的大部分方面必须是习得的。最初的假设是，它们的习得方式与语法一样，是通过可理解的输入获得的。满足本章提出的要求也需要会话技巧的习得，考虑到课堂在时间和语篇方面的局限，这是一项非常困难的任务。

但是，可以直接教授一小部分会话管理工具，它们既可以作为规则，也可以作为背诵的例句，只要它们易于学习(参见关于学习的部分，以便遵循)。例句包括开始对话的、表示暂停和请求帮助的措辞(Scarcella，p.11)。此外，近年来还引入了大量的课内和课外趣味活动来培养会话技巧。

我在这一部分的主要观点是，会话技巧为学生提供了管理会话所需的工具，因此是教学的重要组成部分，因为它有助于确保语言学习发生在课堂外，并在教学计划结束后持续。我们的责任不会随着学期的结束而结束：事实上，在我看来，语言教学的目的是为学生提供他们需要的东西，这样他们就可以在没有我们的情况下取得进步。
