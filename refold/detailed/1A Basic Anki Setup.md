...
正如在[阶段 0：主动非沉浸学习](https://refold.la/roadmap/stage-0/c/active-study)中所述：我们会运用间隔重复系统（简称 SRS）来针对性地学习目标语言词汇。
...
当你打开 Anki 时，首先映入眼帘的便是你的牌组列表。一开始，你只会有一个默认的牌组，名为「Default」。
...
Anki自带的默认选项设置有很多问题，为了适应语言学习，有必要进行精细调整。
