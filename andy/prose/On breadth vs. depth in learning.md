...
在教育科技领域，设计师们经常讨论如何推进学习的[帕累托边界](https://en.wikipedia.org/wiki/Pareto_frontier)。这个概念是指，如果你有限定的学习时间，并且用上了现有最佳的学习方法，你能在某个特定主题上达到一定的深度。但如果我们能开发出新的方法，就能延伸这个上限，让你在同样的时间里学得更加深入。反过来，如果你想在某个领域达到特定水平，新技术可能会缩短最佳路线所需的时间。

我觉得，把这个框架中的时间轴换成「魄力」、「精力」或「热情」，会让它更加贴切。

跟传统抽认卡学习法比起来，用计算机算法安排的间隔重复系统，可以让我在同样时间内记得更多、更深刻。但我觉得，限制我用传统抽认卡的主要不是时间。更大的问题是，用传统抽认卡很快耗尽了我的热情。几个环节后，大多数卡片我都记得很清楚的，基本不用再复习。但这种方法还是要求我每张卡片都看一遍，回答每个问题，确保那些难点能得到强化记忆。间隔重复系统的时间表拉得更长，虽然没完全解决这个问题，但至少减轻了这种学习的魄力税。而且因为它让我重点复习那些我容易忘记的卡片，我感觉复习更有价值，从而激发了我的魄力。这些特点让我更愿意用间隔重复系统，而不是传统抽认卡。

我喜欢把播客和演讲的播放速度调到两到三倍。这不是因为我想快点「听完它们」，而是正常速度下，这些内容不够精彩，没办法让我保持兴趣。如果按原速播放，我往往会心神飘忽，或者想换别的东西听。提高播放速度就像是个小技巧，让我在一定的兴趣程度上能从这些媒体中获得更多。

像可汗学院这种个性化学习系统，就是想通过算法把练习题排序好，让每个学生都能做到最合适的题目。大家常常从「学得更快」这个角度来看这事儿，但我觉得最关键的还是学习的热情。如果一连串的题目你都能轻松搞定，学习的劲头就会很快没了。如果题目太难，超出你的水平，也会让你的积极性大打折扣。这样一来，我们就得从激发学习热情的角度来看这个问题，而不光是算算能不能答对题目。这就让我们思考，怎样安排一些对学生来说既有意义又有吸引力的活动。

我对这个助记媒介和[最近我提出的基于高亮笔的记忆系统](https://www.patreon.com/posts/highlight-driven-90101210)特别感兴趣，原因也差不多。确实，写出好的记忆卡片需要花时间和专业技巧，但很多时候，真正的难点在于学习的积极性。要写出全面的卡片，既繁琐又累人，结果往往是我实际写的远远少于我愿意复习的数量。如果能改变这种状况，要么是在相同的积极性下深入学习得更多，要么是用更少的努力达到同样的深度，那该多好啊。
...
我的编程故事之所以可能，是因为编程是一个可以在几乎不理解的情况下开始进行有意义活动的领域。烹饪也是如此。有这种特性的主题特别适合从做中学。学习的问题主要变成了如何协调辅助活动来填补在学习过程中显现的概念空缺。根据我的经验，最可能的失败模式是我在概念学习上花的时间太少，因为我无法分辨自己的知识空缺，或者无法看到获得某些理解的可能价值。

另一方面，对于大多数主题，我开始深入研究前，都需要一定程度的「书面学习」。面对这种情况，我有自己的一套方法。

一种方法是，我把最初的「书面学习」当作是画地图。我先浅尝辄止地阅读，弄清楚我想做什么项目，需要学哪些东西才能做起来。这样一来，我再去深入阅读这些片段，相信我会得到一些有意义的活动作为回报。
...
但我认为，这些反对意见也揭示了记忆系统的一些重要问题。复习往往感觉枯燥乏味，跟我真正感兴趣的事情没什么关联。很经常，对某个想法的讨论让我着迷，但当记忆系统里的相关卡片出现时，我却提不起兴趣。而且，跟技能有关的练习似乎效果不大，因为我并不是在实际使用这些知识的环境中进行练习。我认为，无论是更熟练地运用现有系统，还是创造新的系统级改进，我们都有可能解决这些问题。
