...
这是后 COVID 世界的桌游之夜。你和几个朋友围着桌子，尝试新游戏。你面对的问题是：有很多小纸板令牌和扑克牌，甚至还有......图腾？我不确定。

你拿起说明书，向大家大声朗读，但几分钟后，大家变得焦躁不安。所以你想：开始吧，边读边想。现在，第一个回合要花很长时间，因为你每隔十秒钟就要回到说明书上，但你总是忘记定位，每次都需要重新定位；在第二个回合结束后，你意识到你需要解除第一个回合，因为你做了一个无效的动作，这将破坏游戏；你不断努力记住你「应该做什么」；如果玩一会儿就需要参考说明书，就很难沉浸体验游戏。

也许我们还不如看一场电影？

我已经在这里和[其他地方](https://andymatuschak.org/books/)写了很多书籍存在的一个问题：我们往往会迅速忘记除了要点的所有东西。因此，书本的另一个问题，特别是那些培养技能的书本：这种媒介使得纸上得来与躬行有了鸿沟。书籍很少涉及**做**他们所讲的事情。大多数书，甚至是旨在培养技能的书，都只是**关于**它们所讲的内容。阅读关于桌游的书，而不是玩桌游。读关于对位法的书，而不是在作曲中使用对位法\*。（\*译注：类似于和声，都是一种构建声部的方法）

那又怎样？我在这里不谈正式的学习科学，而只诉诸经验。

如果你问人们，他们何时成长最快，你会发现最赋能的环境往往涉及**躬行**。一个夏天，你和你的团队为即将到来的比赛做了紧张的准备；一个创业公司虽然失败了，但学到了许多宝贵的经验；接受挑战，在一个月内每天写一首新歌；一个为期数周的冥想静修；一个压倒性的学徒期；等等。在这些故事中，书本有时是知识的来源，但相对于伟大的导师、队友、背景动机等，它们往往是次要的，关键是**躬行**。

可以自然地类比我们的桌游问题：假设你是第一次玩桌游，但是和老司机一起玩。这与之前说明的「冷启动」体验完全不同。在这种情况下，有经验的玩家可能会给你一个简单的介绍——没有什么会降低你的记忆力，然后开始玩。他们会处理好桌游的设置，自己来，或者告诉别人洗这些牌，分发这些牌，等等。他们可能会讲述：「我先来，做个示范。所以我先抽两张牌，然后我可以选择在这里移动或打这张牌。我将在这里移动，这将阻止约翰移动到这个开放区域。现在你上场了。你的目标是去 XYZ，你可能会从这边开始移动。现在，如果你抽到了行动卡，如果你愿意，你可以立即发挥；否则，请阅读卡上的内容......」随着整个游戏中事件的发生，他们可能会继续，及时叙述你需要知道的东西，解释可能考虑的选项，提供反馈。只要你有经验的朋友有足够的风度，避免进入盛气凌人的 Clippy 领域，这样学习游戏就更令人愉快和有效。

这可能是长久以来的入门桌游的好方法，但技能培养书有许多实际的优势。比如信息密度。如果你想学习为量子计算机编程，在你自己能「玩」很多之前，你需要吸收大量的材料。这可能需要有经验的同伴为你解释几十个小时，对大多数人，这会成为负担。解释性散文可能缺乏个性化和人际联系，但它可以被更仔细地打磨；它不会疲倦，只要你准备好了；它可以嵌入数字和抽象符号；它可以被非线性地吸收；它读起来比说话更快；等等。也许最重要的是，它是一种大众媒介。世界上最深刻的专家和最敏锐的传播者可以就这一主题精心编写一本书，而数百万人可以以有效的零边际成本将其捧在手心。

那么：我们如何才能创造出一种大众媒介，它拥有书的优点，但它是**定位于做的？**我们如何才能创造出一种解释性的大众媒介，它感觉更像是和有经验的朋友一起玩桌游，而不是一边玩桌游一边查说明书？

**动态媒介的作用**

关于以实践为中心的书，很难创造出的一个原因是：书是静态的，固定的。你，读者，必须把它的文字摆渡到一个你可以「做」的环境中。即使如此，在「实践」和页面上的文字之间几乎不能相互作用。作者可以建议如何反思练习并产生自己的反馈，但这些都是你必须在自己的头脑中执行的脚本。视频并没有明显地改变这种情况。但是，计算机的承诺，以及它们促成的动态媒介，是有**行为和反应**的表现。[1]

人们经常建议我们利用这一特性来整合**用于实践的模拟环境**。也许生物课本可以嵌入一个小的模拟培养皿，你可以用它来「做」某些种类的细胞生物学，减少文字和行动之间的距离。

但至少在有可能的地方，我对下面的更感兴趣：当一个计算环境**成为**真实的——而不是模拟的，不是「教育的」——实践环境时会发生什么。非线性视频编辑界面并不是编辑电影的「玩具」方式；它们是专业电影人实际编辑电影的方式。Mathematica 也不是操作符号表达的「玩具」；它是某些类型的数学工作真正的最佳完成方式。因此，一本关于视频编辑的动态「书」不需要涉及一个「玩具」的操作环境，一个模拟的培养皿。相反，它可以把自己放在用于编辑地球上最好的电影的那种环境中。

但是，对于一个解释媒介来说，在这样的真实环境中「定位」是什么意思？解释的内容如何与环境的内容互动？

在过去的十年中，作者和程序员已经创造了几十种互动文章，这些文章可能会给我们的答案提供参考（见[与互动文章沟通](https://distill.pub/2020/communicating-with-interactive-articles/)，以获得良好的概述）。就我个人而言，我发现这个领域的工作非常鼓舞人心。但我不知道有哪项工作吻合我们目前所讨论的愿望。这些文章可能是互动的，可能涉及到一些实践，但这些实践是在专门建造的小沙盒中进行的，而不是你正在建立的，用来部署技能的实际环境。它们与模拟培养皿，而不是一个实际的实验台，结合在一起。

例如，一篇[关于编程主题的文章](http://tomasp.net/coeffects/)的结构可能是一个长文本，其中穿插着小型的交互式代码编辑器，你可以用来探索一个概念。这当然是对典型论文的改进！但是相对于我们的愿望，「实践」在这里非常次要。这些编辑器并不像一个实际的编程环境；你必须跳过重重障碍，才能学以致用。这有点像读一本桌游的说明书，里面有交互式的图片，描述了桌游的简化部分。或者，更不公平的是：这有点像一本精心制作的弹出式图书。你仍然没有真正做这件事。
...
这本来可以是一篇博客文章，在段落之间穿插一些互动的「演示」区域。但相反，你是在完整的 Figma  环境中操作这份文件。在设计领域，这是一个实验台，而不是一个模拟的培养皿。除了脚手架上的文字外，这里的「做」和你自己的创造性工作中的「做」之间没有任何距离。阅读这份文件时，我发现自己很好奇，如果小组的结构不同，粘贴行为会如何进行，所以我简单地使用了我已经了解的工具来设置，并回答了自己的问题。然后那天晚些时候，我发现自己——不知不觉地——在我正在设计的版面中使用了一种新的粘贴行为。
...
[1] 这个框架来自布雷特-维克多的"[停止画死鱼](https://vimeo.com/64895205)"。在这里，不可改变的人物（无论是印刷的还是动画的）都是 "死鱼"。

[2] 那么像Mathematica和Jupyter这样的计算笔记本呢？我不认为这些符合条件；我不知道有什么强有力的例子是 "以做为中心 "的，即在文本中穿插的代码列表确实是关于*做*有关的主题。正如Pavel Pancheckha在讨论他的[网络浏览器工程](https://browser.engineering/)一书时向我指出的那样：这种格式似乎侧重于帮助读者理解作者写的代码；它不太适合支持读者自己写代码。

[3] 当然，一些非常好的例子（包括Braid和The Witness）根本就没有使用公开的解释。这是一种极其强大的方法，我将不得不在另一个时间讨论。
