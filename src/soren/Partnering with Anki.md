...
如果说有效的 Anki 用法是你与软件之间的伙伴关系，那么 Anki 的职责是什么，而你的职责又是什么呢？让我们先从 Anki 的角色说起，因为它的责任其实很有限，也很容易说明。
...
在复习过程中，你可能会遇到一些[内容不够精确](https://controlaltbackspace.org/memory/designing-precise-cards/)的卡片。这时，你应该及时修正，以免因为与实际理解无关的原因而反复失败。如果发现自己对某个主题存在知识盲点，就应该立即弥补——切记，不要在不理解的情况下盲目记忆卡片或学习主题。有时你可能会发现某些信息你已经不再关心了，此时可以直接删除相应的卡片。另外，如果你发现自己经常混淆某两个概念，就需要仔细梳理它们之间的差异，以避免再次犯错。
